...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "cloud-clipboard-go 启动器"))
        self.label_2.setText(_translate("MainWindow", "服务监听地址："))
        self.label.setText(_translate("MainWindow", "服务监听端口："))
        self.label_3.setText(_translate("MainWindow", "指定配置文件路径："))
        self.fileChooseBtn.setText(_translate("MainWindow", "选择路径"))
        self.label_4.setText(_translate("MainWindow", "指定外部前端文件路径："))
